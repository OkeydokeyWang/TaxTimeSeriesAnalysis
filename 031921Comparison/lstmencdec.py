...
from keras.models import Sequential
from keras.layers import Dense, Dropout, LSTM, Flatten, TimeDistributed, RepeatVector
...
def lstm_model(train_x, unit_count):
    model = Sequential()
    model.add(LSTM(units=unit_count, input_shape=(train_x.shape[1], train_x.shape[2])))
